...
public class PeriodTest {
    public static void main(String[] args) {
        ...
        System.out.println("\nMeses em um período de semanas");
        System.out.println(p3.getMonths()); // Não mostra o esperado
        System.out.println(Period.between(now, now.plusDays(p3.getDays())).getMonths()); // Não mostra o esperado
